...
import pathlib
from replies.client.Types import StandardResponse, DeleteUserMessage
...
class DeleteUserRequest(BaseRequest):
    ...
    def __init__(self, project: str, service: str,
        ...
        super().__init__(project, service, 'delete_user', qos,
                         serializer, deserializer, request_queue, timeout)

    def send_request(self, userName: str, **kwargs) -> StandardResponse:
        self._request = DeleteUserMessage(userName=userName)
